...
//			int checkB = 0;
//		
//			if (count == 0 && (nums[i]==1 || nums[i]==2 ||  nums[i]==3)) {
//				checkA=i;
//				count++;
//				continue;
//			}
//			if (count == 1 && (nums[i]==1 || nums[i]==2 ||  nums[i]==3) && i !=checkA) {
//				checkB=i;
//				count++;
//				continue;
//			}
//			if (count >= 2 && (nums[i]==1 || nums[i]==2 ||  nums[i]==3) && i !=checkA && i != checkB) {
//				count++;
//			}
//		}
//		if (count >= 3) {
